...
@router.get('/admin-role/{user_id}', response_model=adminRole, dependencies=[Depends(verify_api_key)])
...
@router.post('/admin-role', response_model=adminRole, status_code=201, dependencies=[Depends(verify_api_key)])
...
@router.patch('/admin-role/{user_id}', response_model=adminRole, status_code=200, dependencies=[Depends(verify_api_key)])
